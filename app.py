...
def get_distance_in_kilometers(origin, destination):
    ...
    if response.status_code == 200:
        ...
        print(f"Fout bij het ophalen van de afstandsgegevens: {requests.status_codes}")
...
def main():
    ...
    origin = get_user_location("Voer uw huidige locatie (plaatsnaam) in: ")
    destination = get_user_location("Voer uw bestemming (plaatsnaam) in: ")
